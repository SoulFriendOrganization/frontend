...
function HomePage() {
  return (
    <div className="w-full min-h-svh bg-[#FFEBC8] flex flex-col items-center">
        ...
        <div className="px-4 flex flex-col items-center justify-center w-full max-w-7xl mx-auto py-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
                ...
                <div className="flex flex-col items-center justify-between p-6 rounded-lg bg-white/50 shadow-sm h-full">
                    <div>
                        ...
                        <p className="text-center text-gray-700 mb-6">Verifikasi keaslian website untuk menghindari informasi hoax dan judi online</p>
                    </div>
                    <div className="w-full rounded-md overflow-hidden text-white">
